...
<template>
  <div class="sticky top-[2vw] h-fit" v-if="state === 0">
    <div class="h-[73px] xxl:h-[56px] xl:h-[48px] relative z-20 border__top-6 bg-[#f5f5f5]   flex items-center justify-between p-7 xxl:p-5 xl:p-4">
    ...
    <div class="overflow-hidden">
      <div class="relative custom__scroll border__bottom-6 overflow-x-hidden overflow-y-auto bg-[#f5f5f5]   transition-all duration-500 max-h-[84vh] p-6 xxl:p-4 xl:p-3 leading-none">
  ...
  <div class="sticky top-[2vw] h-fit" v-else>
    <div class="relative z-20 border__top-6 bg-[#f5f5f5]   flex items-center justify-between p-7 xxl:p-5 xl:p-4">
    ...
    <div class="relative z-10 h-[1px] w-full bg-[#E5DFEE]"></div>
    <div class="overflow-hidden">
      <div class="relative custom__scroll border__bottom-6 overflow-y-auto bg-[#f5f5f5]   transition-all duration-500 max-h-[90vh] p-6 xxl:p-4 xl:p-3 leading-none">
