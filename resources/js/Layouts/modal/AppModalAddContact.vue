      ...
      <div class="flex items-center gap-5 xxl:gap-4 xl:gap-3">
        <div>
          <div class="relative w-20 xxl:w-16 xl:w-14 h-20 xxl:h-16 xl:h-14 rounded-full">
            ...
            <button v-if="myPhoto && myPhoto !== '/storage/support/'" @click="deletePhoto" class="absolute rounded-full bg-[#255ECC] z-10 top-0 left-0 h-5 xxl:h-4.5 xl:h-4 w-5 xxl:w-4.5 xl:w-4">
