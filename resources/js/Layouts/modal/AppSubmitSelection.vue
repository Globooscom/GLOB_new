  ...
  <div class="fixed z-[100] w-full h-full flex items-center justify-center">
    <div class="relative bg-white rounded-[12px] p-10 xxl:p-9 xl:p-8 lg:p-5 z-50 w-[30%] lg:w-[48%] md:w-[60%] sm:w-[90%] h-fit">
      ...
      <div class="relative mt-10 xxl:mt-8 xl:mt-6">
        <input :value="valueLink" ref="text" disabled class="copy-link w-full text-[#1E1D2D] text-[16px] focus:ring-[#255ECC] focus:border-[#255ECC] xxl:text-[14px] xl:text-[12px] pl-5 xxl:pl-4 xl:pl-3 py-3 xxl:py-2.5 xl:py-2 leading-none rounded-[5px] border border-solid border-[#E5DFEE] pr-12 xxl:pr-10 xl:pr-8" type="text">
