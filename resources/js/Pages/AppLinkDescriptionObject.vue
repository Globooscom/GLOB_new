...
<template>
  ...
  <header class="relative">
    ...
    <img v-else class=" h-[13.4vw] lg:h-[130px] w-full absolute top-[60px] xxl:top-12 xl:top-10 lg:top-12 left-0"
          ...
          <div class="contact__selling h-fit bg-white rounded-[10px] p-4 xxl:p-3 xl:p-2.5 mb-7 xxl:mb-5 xl:mb-4">
            <div class="flex items-center gap-5 xxl:gap-4 xl:gap-3 mb-5 xxl:mb-4 xl:mb-4">
              <img class="w-14 xxl:w-12 xl:w-10 h-14 xxl:h-12 xl:h-10 rounded-full object-cover"
                v-if="compilation.user.image" :src="compilation.user.image" alt="">
              <div class="flex flex-col gap-2 xxl:gap-1.5 xl:gap-1">
                <span class="text-[18px] xxl:text-[15px] xl:text-[13px] lg:text-[15px] leading-none font-medium">{{
            ...
            <div class="flex flex-col gap-4 xxl:gap-3 xl:gap-2.5">
              <div class="flex cursor-pointer bg-[#f5f5f5]   p-4 xxl:p-3 xl:p-2.5 rounded-[5px]">
                ...
                <span
                  class="leading-none text-center w-full text-[#6536A5] text-[16px] xxl:text-[14px] xl:text-[12px] lg:text-[14px]">{{
                    compilation.user.phone }}</span>
              </div>
              <div class="flex cursor-pointer bg-[#f5f5f5]   p-4 xxl:p-3 xl:p-2.5 rounded-[5px]"
                v-if="validEmail(compilation.user.email)">
