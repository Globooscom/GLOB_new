    ...
    <div class="_container">
      <div class="my-14 xxl:my-10 xl:my-8">
        <div class="flex justify-between items-center mb-7 xxl:mb-5 xl:mb-4">
          ...
          <Link href="/profile/addedHouse" class="text-base xxl:text-sm xl:text-xs text-white bg-[#255ECC] leading-none rounded-[3px] px-6 xxl:px-5 xl:px-4 py-2.5 xxl:py-2 xl:py-1.5">{{ language.menu_zastr[2] }}</Link>
        </div>
        <div v-if="houses.length === 0" class="grid grid-cols-2 lg:grid-cols-1 mt-10 xxl:mt-8 xl:mt-6">
          <div class="flex justify-between sm:flex-col sm:items-center p-7 xxl:p-5 xl:p-4 bg-[#f5f5f5]   rounded-[10px]">
            ...
            <svg class="h-full" width="162" height="113" viewBox="0 0 162 113" fill="#255ECC" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <div class="flex flex-col" v-for="house in searchObject">
            <div class="object__block relative h-[500px] exl:h-fit exl:h-[26vw] md:h-[52vw]">
              ...
              <div class="hide absolute flex gap-2 top-0 left-0 p-5 xxl:p-4 xl:p-3">
                <span class="bg-[#255ECC] rounded-[3px] px-2 xxl:px-1.5 xl:px-1 py-1.5 xxl:py-1 xl:py-0.5 text-white text-sm xxl:text-xs xl:text-[10px] leading-none" v-if="house.active === 0">{{ language.ob[39] }}</span>
                <span class="bg-[#255ECC] rounded-[3px] px-2 xxl:px-1.5 xl:px-1 py-1.5 xxl:py-1 xl:py-0.5 text-white text-sm xxl:text-xs xl:text-[10px] leading-none" v-if="house.active === 1">не прошло модерацию</span>
            ...
            <div class="flex flex-col p-5 xxl:p-4 xl:p-3">
              ...
              <div class="relative">
                <span @click="house.openWatchTime = !house.openWatchTime" class="w-fit cursor-pointer flex items-center gap-2 xxl:gap-1.5 xl:gap-1">
                  ...
                  <span class="text-[#8A8996] leading-none text-lg xxl:text-[15px] xl:text-[13px]"><span class="text-[#255ECC]"> {{ house.views === null ? house.view[0] : house.views }} </span> {{ house.selectTime === null ? house.watchTime[0].time : house.selectTime }}</span>
